...
Middleware are functions that get executed in the order they are used on the server.

1. The basic principles of the REST architectural style.

REST is a set of principles that define a way to design distributed software, a generally agreed upon set of principles and constraints.

1. Understand and explain the use of Express Routers.

Express Routers are a way to split an application up into smaller components to make it more modular and easier to maintain.

1. Describe tooling used to manually test the correctness of an API.

One tool available to test API's is Postman. With Postman you can test your endpoints to make sure that you are getting the proper response from your server.
